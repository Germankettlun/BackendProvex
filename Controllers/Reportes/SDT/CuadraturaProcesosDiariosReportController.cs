...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class CuadraturaProcesosDiariosReportController : ControllerBase
    {
        private readonly string _conn;

        public CuadraturaProcesosDiariosReportController(IConfiguration cfg)
        {
            _conn = cfg.GetConnectionString("ProvexDb")!;
        }

        [HttpGet("CuadraturaProcesosDiarios")]
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_CuadraturaProcesosDiarios");
                ...
                LogHelper.Log("Cuadratura Procesos Diarios | Query : " + sql, "Reportes");
            ...
            {
                LogHelper.Log("Cuadratura Procesos Diarios | Error : " + ex.Message, "Reportes");
            }
