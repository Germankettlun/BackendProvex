...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class ProgramaComercialController : ControllerBase
    {
        private readonly string _conn;

        public ProgramaComercialController(IConfiguration cfg)
        {
            _conn = cfg.GetConnectionString("ProvexDb")!;
        }

        [HttpGet("ProgramaComercial")]
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_Remoto_PC");
                ...
                LogHelper.Log("Produccion | Query : " + sql, "Reportes");
            ...
            {
                LogHelper.Log("PC remoto | Error : " + ex.Message, "Reportes");
            }
