...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class ProduccionReportController : ControllerBase
    {
        private readonly string _conn;

        public ProduccionReportController(IConfiguration cfg)
        {
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_Produccion");
            ...
            {
                LogHelper.Log("Produccion | Error : " + ex.Message, "Reportes");
            }
