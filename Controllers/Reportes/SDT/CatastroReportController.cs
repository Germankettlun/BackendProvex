...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class CatastroReportController : ControllerBase
    {
        private readonly string _conn;

        public CatastroReportController(IConfiguration cfg)
        {
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_Catastro");
