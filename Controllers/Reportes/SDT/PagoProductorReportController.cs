...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class PagoProductorReportController : ControllerBase
    {
        private readonly string _conn;

        public PagoProductorReportController(IConfiguration cfg)
        {
            _conn = cfg.GetConnectionString("ProvexDb")!;
        }

        [HttpGet("PagoProductor")]
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_PagoProductor");
                ...
                LogHelper.Log("Pago Productor | Query : " + sql, "Reportes");
            ...
            {
                LogHelper.Log("Pago Productor | Error : " + ex.Message, "Reportes");
            }
