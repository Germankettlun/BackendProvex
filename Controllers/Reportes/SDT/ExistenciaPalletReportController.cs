...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class ExistenciaPalletReportController : ControllerBase
    {
        private readonly string _conn;

        public ExistenciaPalletReportController(IConfiguration cfg)
        {
            _conn = cfg.GetConnectionString("ProvexDb")!;
        }

        [HttpGet("ExistenciaPallet")]
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_ExistenciaPallet");
                ...
                LogHelper.Log("Existencia Pallet | Query : " + sql, "Reportes");
            ...
            {
                LogHelper.Log("Existencia Pallet | Error : " + ex.Message, "Reportes");
            }
