...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class FrutaComercialReportController : ControllerBase
    {
        private readonly string _conn;

        public FrutaComercialReportController(IConfiguration cfg)
        {
            _conn = cfg.GetConnectionString("ProvexDb")!;
        }

        [HttpGet("FrutaComercial")]
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_FrutaComercial");
                ...
                LogHelper.Log("Fruta Comercial | Query : " + sql, "Reportes");
            ...
            {
                LogHelper.Log("Fruta Comercial | Error : " + ex.Message, "Reportes");
            }
