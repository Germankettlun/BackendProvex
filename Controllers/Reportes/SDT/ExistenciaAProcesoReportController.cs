...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class ExistenciaAProcesoReportController : ControllerBase
    {
        private readonly string _conn;

        public ExistenciaAProcesoReportController(IConfiguration cfg)
        {
            _conn = cfg.GetConnectionString("ProvexDb")!;
        }

        [HttpGet("ExistenciaAProceso")]
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_ExistenciaAProceso");
                ...
                LogHelper.Log("Existencia A Proceso | Query : " + sql, "Reportes");
            ...
            {
                LogHelper.Log("Existencia A Proceso | Error : " + ex.Message, "Reportes");
            }
