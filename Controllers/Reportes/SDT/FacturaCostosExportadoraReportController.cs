...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class FacturaCostosExportadoraReportController : ControllerBase
    {
        private readonly string _conn;

        public FacturaCostosExportadoraReportController(IConfiguration cfg)
        {
            _conn = cfg.GetConnectionString("ProvexDb")!;
        }

        [HttpGet("FacturaCostosExportadora")]
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_FacturaCostosExportadora");
                ...
                LogHelper.Log("Factura Costos Exportadora | Query : " + sql, "Reportes");
            ...
            {
                LogHelper.Log("Factura Costos Exportadora | Error : " + ex.Message, "Reportes");
            }
