...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class CargosManualesReportController : ControllerBase
    {
        private readonly string _conn;

        public CargosManualesReportController(IConfiguration cfg)
        {
            _conn = cfg.GetConnectionString("ProvexDb")!;
        }

        [HttpGet("CargoManuales")]
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                var sql = new StringBuilder("SELECT * FROM PROVEX.dbo.SDT_View_CargosManuales");
                ...
                LogHelper.Log("Cargos Manuales | Query : " + sql, "Reportes");
            ...
            {
                LogHelper.Log("Cargos Manuales | Error : " + ex.Message, "Reportes");
            }
