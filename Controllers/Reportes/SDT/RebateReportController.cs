...
namespace ProvexApi.Controllers.Reportes.SDT
{
    ...
    [ApiController]
    [Route("reportes")]
    public class RebateReportController : ControllerBase
    {
        private readonly string _conn;

        public RebateReportController(IConfiguration cfg)
        {
            ...
            [FromQuery] string? empresa)
        {
            ...
            try
            {
                ...
                LogHelper.Log("Rebate | Query : " + sql, "Reportes");
            ...
            {
                LogHelper.Log("Rebate | Error : " + ex.Message, "Reportes");
            }
