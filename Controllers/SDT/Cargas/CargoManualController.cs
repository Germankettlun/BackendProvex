...
namespace ProvexApi.Controllers.SDT.Cargas
{
    ...
    [ApiController]
    [Route("api")]
    public class CargoManualController : ControllerBase
    {
        ...
        public CargoManualController(IHttpClientFactory httpClientFactory, IConfiguration configuration, ProvexDbContext db, TemporadaService temporadaService)
        {
        ...
        [FromQuery] bool guardarEnBD = true, [FromQuery] string? temporada = null, [FromQuery] string? empresa = null)
        {
            ...
            {               
                ...
                var dataResponse = await SdtApiHelper.GetDataAsync<CargoManualResponse>(url,api.ApiAuthUser, api.ApiAuthPassword, api.ApiTimeOut);
            ...
            catch (Exception ex)
            {
                ...
                return await ErrorResponseHelper.HandleExceptionAsync(ex, _configuration, "Cargos Manuales");
            }
        }
    }
}
